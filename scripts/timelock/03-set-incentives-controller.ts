...
const iface = new Interface([
  "function setIncentivesController(address _controller)",
]);

const salt = keccak256(toUtf8Bytes("SetIncentivesController"));
...
const encodedData = iface.encodeFunctionData("setIncentivesController", [
